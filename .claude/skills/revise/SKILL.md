...
- Skeptic: which critiques are valid vs. misunderstandings? Which point to real weaknesses?
- Methodologist: which critiques require new analysis, experiments, or methodological changes?
...
Step 3 — Debate:
- All: where do we push back vs. concede? What's the minimum viable revision vs. the version that makes the work genuinely better?

Output: revision plan, response strategy, and list of additional work needed.
